...
```{r}
# https://cran.r-project.org/web/packages/hablar/vignettes/retype.html
circ <- circ %>%
  hablar::retype()
```
...
```{r}
write.table(circ, file = "~/Documents/GitHub/LIS-598-Sp2020-DC2-testing/Data/SnoIsleCircSample_NoMess.csv", sep = "|", row.names = FALSE, quote = FALSE)
```
